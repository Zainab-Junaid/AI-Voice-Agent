...
When a user calls the Twilio number, the agent listens, understands what the caller says, and responds naturally. It can place new orders or look up existing ones — everything runs in real time using Deepgram and OpenAI.
